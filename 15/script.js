...
background = new GraphBackground(context, "black");
...
function animate(){
    ...
    pab.draw(context, "rgba(255,0,0,0.4)");
    pac.draw(context, "rgba(255,0,0,0.4)");
    pbc.draw(context, "rgba(255,0,0,0.4)");
